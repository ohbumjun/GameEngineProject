...
/* #include "editor/experiment/LvFileWatcher.h" */ namespace Lv { namespace Editor { struct LvFileWatcher; } }
/* #include "editor/experiment/LvFileWatcher.h" */ namespace Lv { namespace Editor { struct LvFileWatcherEventHandler; } }
/* #include "editor/experiment/LvFileWatcher.h" */ namespace Lv { namespace Editor { enum LvFileWatcherEventType : int; } }
/* #include "editor/private/project/LvFileManagerEventArgs.h" */ namespace Lv { namespace Editor { namespace Project { enum class LvFileManagerChangeType : uint8; } } }
/* #include "editor/private/project/LvFileManagerEventArgs.h" */ namespace Lv { namespace Editor { namespace Project { struct LvFileManagerEventArgs; } } }
/* #include "editor/private/project/LvFileTable.h" */ namespace Lv { namespace Editor { namespace Project { class LvFileTable; } } }
/* #include "editor/asset/LvAsset.h */ namespace Lv { namespace Editor { class LvAsset; } }
...
namespace Project
{
	...
	public:
		...
		using FilesDispatcher = LvRawEvent<const LvList<LvFileManagerEventArgs>&>::Dispatcher;
		 ...
		 */
		static LvRawEvent<const LvList<LvFileManagerEventArgs>&> onDetectFilesEvent;
		...
		*/
		 ...
		 */
		static const LvString& GetProjectPath() { return _projectPath; }
		 ...
		 * @endcode
		 */
		static LvString ToRelativePath(const LvString& absolutePath) { return ToRelativePath(absolutePath.c_str()); }
		 ...
		 * @endcode
		 */
		static LvString ToAbsolutePath(const LvString& relativePath) { return ToAbsolutePath(relativePath.c_str()); }
		 ...
		 * @endcode
		 */
		static bool IsExist(const LvString& target) { return IsExist(target.c_str()); }
		 ...
		 * @endcode
		 */
		static bool IsExistFromAbsolute(const LvString& absoluteTarget) { return IsExistFromAbsolute(absoluteTarget.c_str()); }
		 ...
		 * @endcode
		 */
		static bool IsDirectory(const LvString& target) { return IsDirectory(target.c_str()); }
		 ...
		 * @endcode
		 */
		static bool IsDirectoryFromAbsolute(const LvString& absoluteTarget) { return IsDirectoryFromAbsolute(absoluteTarget.c_str()); }
		 ...
		 * @endcode
		 */
		static LvFileStream CreateFileStream(const char* target, LvFileMode fileMode);
		 ...
		 * @endcode
		 */
		static LvFileStream CreateFileStreamFromAbsolute(const char* target, LvFileMode fileMode);
		 ...
		 * @endcode
		 */
		static bool Delete(const LvString& target) { return Delete(target.c_str()); }
		 ...
		 * @endcode
		 */
		static bool Copy(const char* source, const char* target, LvString* outCopiedPath = nullptr);
		 ...
		 * @endcode
		 */
		static bool CopyFromAbsolute(const char* source, const char* target, LvString* outCopiedPath = nullptr);
		 ...
		 * @endcode
		 */
		static const LvFileInfo& GetFileInfoAtAbsolutePath(const char* absolutePath);
		 ...
		 * @endcode
		 */
		static const LvFileInfo& GetFileInfoAtPath(const LvString& path) { return GetFileInfoAtPath(path.c_str()); }
		 ...
		 */
		static const LvList<LvString>& GetChildrenAtAbsolutePath(const char* absolutePath);
		 ...
		 */
		static LvString GetUniqueName(const LvString& name, const LvString& parentPath, const LvString& extensionWithDot);
		 ...
		 * @param extensionWithDot '.' 이 포함된 확장자
		 */
		static LvString GetClonePath(const LvAsset* asset, const LvString& name, const LvString& extensionWithDot);
		...
		static const LvFileTable* GetTable() { return _table; }
	...
	private:
		struct WatchData
		{
			...
			WatchData(LvFileManagerChangeType type, const char* source, const char* destination) :
				type(type),
				source(source),
		...
		static void record(LvFileManagerChangeType type, const char* source, const char* destination);
		static bool onWatch(LvFileWatcherEventType eventType, const char* src, const char* dst);
		static bool onWatch(LvFileManagerChangeType type, const char* src, const char* dst);
