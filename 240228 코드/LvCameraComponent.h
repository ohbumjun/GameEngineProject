...
class LV_API LV_REFLECT LV_ATTRIBUTE(LvShowOrderAttribute(10))
    LV_ATTRIBUTE(LvSerializeVersionAttribute(3))
        LV_ATTRIBUTE(LvInspectorNameAttribute("Camera")) LvCameraComponent
    : public LvComponent
{
...
public:
	...
	*/
    LV_FORCEINLINE uint32 GetCullingMask() const
    {
        return (uint32)_cullingMask;
    }
    LV_REFLECT
    ...
    {
        _cullingMask =
            (LvLayerMask)((uint32)_cullingMask | (uint32)cullingMask);
        dirtyFlag.Add(DirtyFlag::CULLING_MASK);
    }
	...
	*/
    LV_FORCEINLINE ProjectionType GetProjectionType() const
    {
	...
	*/
    LV_FORCEINLINE float GetAspect() const
    {
        return _aspect;
    }
    LV_REFLECT
    ...
    LV_FORCEINLINE AntiAliasingMode GetAntiAliasingMode() const
    {
        return _aaMode;
    }
    LV_REFLECT
    ...
    LV_FORCEINLINE RenderType GetRenderType() const
    {
        return _renderType;
    }
	...
	*/
    LV_FORCEINLINE float GetFOVRadian() const
    {
        return _fovRadian;
    }
    LV_REFLECT
	...
	*/
    LV_FORCEINLINE float GetOrthoSize() const
    {
        return _orthoSize;
    }
    LV_REFLECT
	...
	*/
    LV_FORCEINLINE float GetNearPlane() const
    {
        return _nearP;
    }
    LV_REFLECT
	...
	*/
    LV_FORCEINLINE float GetFarPlane() const
    {
        return _farP;
    }
    LV_REFLECT
	...
	*/
    LV_FORCEINLINE const LvMat4f &GetViewMatrix() const
    {
        return _viewMatrix;
    }
	...
	*/
    LV_FORCEINLINE const LvMat4f &GetProjectionViewMatrix() const
    {
	...
	*/
    LV_FORCEINLINE const LvMat4f &GetProjectionMatrix() const
    {
	...
	* @brief 절두체를 반환합니다.
	*/
    LV_FORCEINLINE const LvFrustum &GetFrustum() const
    {
        return _frustum;
    }
    ...
    LV_FORCEINLINE size_t GetStackedCameraCount() const
    {
    ...
    LV_FORCEINLINE LvCameraComponent *GetBaseCamera() const
    {
        return _baseCamera;
    }
	...
	*/
    LV_FORCEINLINE LvRect GetRect() const
    {
	...
	*/
    LV_FORCEINLINE float GetDepth() const
    {
        return _depth;
    }
    LV_REFLECT
	...
	*/
    LV_FORCEINLINE LvResolution GetRenderTargetResolution() const
    {
        return _renderTargetResolution;
    }
	...
	*/
    LV_FORCEINLINE LvVec4f GetBackgroundColor() const
    {
    ...
    LV_FORCEINLINE LvCamera::Clear GetClearFlag() const
    {
        return _clearFlag;
    }
	...
	*/
    ...
    uint32 GetLookAtTargetId() const noexcept
    {
        return _lookAtTargetId;
    }
...
protected:
    ...
    LvLayerMask _cullingMask =
        (LvLayerMask)((uint32)LvLayerMask::DEFAULT |
                      (uint32)LvLayerMask::TRANSPARENTFX |
                      (uint32)LvLayerMask::POST_EFFECT |
                      (uint32)LvLayerMask::ICON |
                      (uint32)LvLayerMask::RESERVED);
