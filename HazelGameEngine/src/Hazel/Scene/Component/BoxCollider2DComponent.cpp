...
Hazel::BoxCollider2DComponent::BoxCollider2DComponent(const BoxCollider2DComponent&)
{
	Reflection::RegistType<BoxCollider2DComponent>();
}
...
{
	serializer->BeginSaveMap(Reflection::GetTypeID<BoxCollider2DComponent>(), this);
...
{
	serializer->BeginLoadMap(Reflection::GetTypeID<BoxCollider2DComponent>(), this);
	std::string compName;
