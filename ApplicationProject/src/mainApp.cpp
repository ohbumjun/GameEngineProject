...
public:
          ...
          m_CameraController(1200.f / 720.f, true)
    {
		...
		*/
        float vertices[3 * 7] = {
            /*pos*/ -0.5f,  -0.5f, 0.0f,
            /*color*/ 1.0f, 0.0f,  1.0f, 1.0f, 0.5f, -0.5f, 0.f,
            /*color*/ 1.0f, 0.0f,  1.0f, 1.0f, 0.0f, 0.5f,  0.0f,
        ...
        squareIdxB = Hazel::IndexBuffer::Create(squareIndices,
        ...
        m_Shader = Hazel::Shader::Create("vertexColorTriangle",
                                         vertexSrc,
                                         fragmentSrc);
        ...
        m_BlueShader = Hazel::Shader::Create("squareBlueShader",
                                             sqaureVertexScr,
                                             sqaureFragSrc);
        ...
        // Create Texture
        m_Texture = Hazel::TextureManager::CreateTexture2D(
            "assets/textures/RandomBox.png");
        m_TransparentTexture = Hazel::TextureManager::CreateTexture2D(
            "assets/textures/opaque.png");
    ...
    void OnUpdate(Hazel::Timestep ts) override
    {
		...
		*/
        ...
        std::dynamic_pointer_cast<Hazel::OpenGLShader>(m_BlueShader)
        ...
        Hazel::Renderer::Submit(m_SquareArray,
                                textureShader,
