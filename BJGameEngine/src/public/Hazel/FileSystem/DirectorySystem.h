...
public:
	...
	static HANDLE OpenFile(const char* path, FileAccessMode accessFlag, FileOpenMode modeFlag);
	 ...
	 * 혹은, WBC  를 MBC 로 변환
	 */
	static void FromSystemToUTF8Path(char* aft_dest_utf8, const void* bef_src_sys);
	 ...
	 */
	static void FromUTF8ToSystemPath(void* dest_sys, const char* src_utf8, bool need_safe_conversion = false);
