...
#define HZ_PROFILE_SCOPE(name)                                                 \
    ::Hazel::InstrumentationTimer time##__LINE__(name);
// __FUNCTION__ : name of function
// __FUNCSIG__   : name 뿐만 아니라 arg 를 통한 구분
#define HZ_PROFILE_FUNCTION() HZ_PROFILE_SCOPE(__FUNCSIG__);
#else
#define HZ_PROFILE_BEGIN_SESSION(name, filePath) : Hazel::Instrumentor::BeginSession(name, filePath)
#define HZ_PROFILE_END_SESSION()
#define HZ_PROFILE_BEGIN_FUNCTION()
#define HZ_PROFILE_BEGIN_SCOPE(name)
#endif