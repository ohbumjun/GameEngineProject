...
void CircleRendererComponent::Serialize(Serializer *serializer)
{
...
void CircleRendererComponent::Deserialize(Serializer *serializer)
{
...
const TypeId CircleRendererComponent::GetType() const
{
